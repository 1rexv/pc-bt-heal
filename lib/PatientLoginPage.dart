...
class _PatientLoginPageState extends State<PatientLoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final emailEmptyError  = isArabic ? "الرجاء إدخال البريد الإلكتروني" : "Please enter your email";
    final emailInvalidErr  = isArabic ? "الرجاء إدخال بريد إلكتروني صالح" : "Enter a valid email";
    final passEmptyError   = isArabic ? "الرجاء إدخال كلمة المرور" : "Please enter your password";
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const PatientForgotPasswordPage(),
                          ),
                        );
                      },
      ...
      try {
        ...
        if (userData['userType'] == 'Patient') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(accessDeniedText)),
          );
        }
